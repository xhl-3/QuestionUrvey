        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" action="/login.do" method="post">>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="name" id="name" placeholder="用户名或电子邮件" required autofocus/>
                </div>
                <div class="form-group help">
                    <input type="password" name="passwd" class="form-control" id="passwd" placeholder="密　码" required autofocus/>
                </div>
                <div class="form-group">
